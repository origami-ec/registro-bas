...
@Named
@ViewScoped
public class IniciarTramiteJuridicoRp extends BpmManageBeanBaseRoot implements Serializable {
    
    private static final Logger LOG = Logger.getLogger(IniciarTramiteJuridicoRp.class.getName());
    ...
    protected void iniView() {
        try {
            actos = manager.findAll(Querys.getRegActosMercantil);
