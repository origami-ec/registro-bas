...
public class InscripcionNuevaDirecta extends BpmManageBeanBaseRoot implements Serializable {
    ...
    private static final Logger LOG = Logger.getLogger(InscripcionNuevaDirecta.class.getName());
        ...
        try {
            ...
            if (movimiento.getNumRepertorio() != null) {
                ...
                mov = (RegMovimiento) manager.find(Querys.getMovimientoByInscRep, new String[]{"libro", "inscripcion", "repertorio", "indice", "anio"},
                        new Object[]{movimiento.getLibro(), movimiento.getNumInscripcion(), movimiento.getNumRepertorio(), movimiento.getIndice(), cal.get(Calendar.YEAR)});
            } else {
    ...
    public void showDlgAllMovs(String url) {
        ss.instanciarParametros();
        this.showDlg(url);
    }
